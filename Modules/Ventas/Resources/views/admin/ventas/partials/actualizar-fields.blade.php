    ...
    <div class="box-body">
      ...
      <div class="row" style="margin-bottom: 20px">
        ...
        <div class="col-md-4">
          ...
          {!! Form:: normalCheckbox('generar_factura', '', $errors, $venta) !!}
        </div>
      </div>
      @if($venta->generar_factura)
      ...
      @endif
        <div class="row" style="display:flex">
          <div class="col-md-8">
            <div class="row">
              <div class="col-md-6">
                {!! Form::normalInput('datos_razon_social', 'Razón Social', $errors, (object)['datos_razon_social' => $venta->razon_social], ['readonly' => 'true']) !!}
              </div>
              <div class="col-md-6">
                {!! Form::normalInput('datos_ruc', 'Ruc', $errors, (object)['datos_ruc' => $venta->ruc], ['readonly' => 'true']) !!}
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                {!! Form::normalInput('datos_telefono', 'Teléfono', $errors, (object)['datos_telefono' => $venta->telefono], ['readonly' => 'true']) !!}
              </div>
              <div class="col-md-6">
                {!! Form::normalInput('datos_direccion', 'Dirección', $errors, (object)['datos_direccion' => $venta->direccion], ['readonly' => 'true']) !!}
              </div>
            </div>
          </div>
          <div class="col-md-2">
    ...
    <div class="box-body">
      <table id="detalles-table" class="data-table table table-bordered table-hover">
        ...
        <tbody id="detallesBody">
          @foreach ($venta->detalles as $detalle_key => $detalle)
            <tr>
              <td>
    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-md-2">
          ...
          <input value="{{$venta->monto_total}}" readonly name="monto_total" class="precio_format form-control" id="monto-total">
        </div>
        <div class="col-md-7">
          <strong>Monto total (en letras): </strong>
          <input value="{{$venta->precio_total_letras}}" readonly type="text" name="precio_total_letras" value="" class="form-control" id="monto-total-letras">
        </div>
        <div class="col-md-2">
          <strong>Total Iva 10%: </strong>
          <input value="{{$venta->total_iva}}"readonly name="total_iva" class="precio_float_format form-control" id="total-iva-10">
        </div>
      </div>
    </div>
  </div>
