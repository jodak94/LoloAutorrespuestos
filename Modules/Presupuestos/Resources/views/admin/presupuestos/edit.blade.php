...
@section('content-header')
    <h1>
        {{ trans('presupuestos::presupuestos.title.edit presupuesto') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('presupuestos::presupuestos.title.edit presupuesto') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.presupuestos.presupuesto.update', $presupuesto->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('presupuestos::admin.presupuestos.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
